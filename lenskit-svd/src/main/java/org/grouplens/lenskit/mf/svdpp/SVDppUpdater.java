...
/**
 * Encapsulation of the SVD++ update process.  Using this class takes a two-step process:
 *
 * <ol>
 ...
 */
public final class SVDppUpdater {
    private final SVDppUpdateRule updateRule;
    ...
    SVDppUpdater(SVDppUpdateRule rule) {
        updateRule = rule;
    }
