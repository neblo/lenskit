...
/**
 * Configuration for computing SVD updates.
 *
 * @since 1.0
 */
@Shareable
public final class SVDppUpdateRule implements Serializable {
     ...
     */
    @Inject
    public SVDppUpdateRule(@LearningRate double lrate,
    ...
    public SVDppUpdater createUpdater() {
        return new SVDppUpdater(this);
    }
}
